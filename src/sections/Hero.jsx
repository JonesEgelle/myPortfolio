  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className=" container mx-auto px-6 pt-32 pb-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-[41px] md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in animation-delay-100">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                Hi, I'm Jones Egelle - a Frontend Engineer specializing in
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-fade-in animation-delay-800 cursor-pointer">
          <a
            href="#about"
            className="flex items-center flex-col gap-2 text-muted-foreground hover:text-primary "
          >
