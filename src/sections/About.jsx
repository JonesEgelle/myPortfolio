        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="animate-fade-in">
              <span className="text-shadow-secondary-foreground text-sm font-medium tracking-wider uppercase">
                {" "}
                About Me
              </span>
            </div>
            ...
            <div className="space-y-4 text-muted-foreground animate-fade-in animation-delay-200">
              ...
              <p>
                ...
                key eye for design and user experience.
              </p>
              <p>
                {" "}
                Beyond coding, you'll find me exploring new technologies,
                gaming, or challenging myself by building hands-on projects and
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {highlights.map((highlight, index) => (
              <div
                ...
                style={{ animationDelay: `${(index + 1) * 100}` }}
              >
